  ...
  try {
    ...
    try {
      const positionsResponse = await axios.get(
        `${baseUrl}/v1/trading/accounts/${accountId}/positions`,
        {
          headers: {
      ...
      // Also get account info for cash balance
      const accountResponse = await axios.get(
        `${baseUrl}/v1/trading/accounts/${accountId}/account`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
      ...
      return NextResponse.json({
        ...
        account: {
          cash: accountResponse.data.cash || '0',
          buying_power: accountResponse.data.buying_power || '0',
          equity: accountResponse.data.equity || '0',
        },
      })
    } catch (error: any) {
