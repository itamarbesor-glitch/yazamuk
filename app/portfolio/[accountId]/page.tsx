    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative container mx-auto px-4 py-6 sm:py-8 md:py-12">
        ...
        <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent break-words">
              Your Portfolio
            </h1>
        ...
        {showWelcome && (
          <div className="mb-4 sm:mb-6 md:mb-8 bg-gradient-to-r from-mint-500/10 to-purple-500/10 border border-mint-500/30 rounded-xl p-3 sm:p-4 md:p-6">
            <div className="flex items-start gap-2.5 sm:gap-3 md:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-base sm:text-lg md:text-xl font-bold text-mint-400 mb-1.5 sm:mb-2 break-words">Welcome to Your Portfolio!</h2>
                <p className="text-gray-300 mb-2 sm:mb-3 text-sm sm:text-base leading-relaxed break-words">
